...
DAYS_NO_CONNECTIVITY_MAX = 750  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 45  # send an offroad prompt after 4 days with no internet
...
def thermald_thread():
  ...
  while 1:
    ...
    # report to server once 10 minute
